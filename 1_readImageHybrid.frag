...
void main() {
    ...
    float kernelSmall[9];
    kernelSmall[0] = 4.0/16.0; kernelSmall[1] = 2.0/16.0; kernelSmall[2] = 4.0/16.0;
    kernelSmall[3] = 2.0/16.0; kernelSmall[4] = 4.0/16.0; kernelSmall[5] = 2.0/16.0;
    kernelSmall[6] = 4.0/16.0; kernelSmall[7] = 2.0/16.0; kernelSmall[8] = 4.0/16.0;

    float kernelLarge[9];
    kernelLarge[0] = 12.0/64.0; kernelLarge[1] = 6.0/64.0; kernelLarge[2] = 12.0/64.0;
    kernelLarge[3] = 6.0/64.0; kernelLarge[4] = 36.0/64.0; kernelLarge[5] = 6.0/64.0;
    kernelLarge[6] = 12.0/64.0; kernelLarge[7] = 6.0/64.0; kernelLarge[8] = 12.0/64.0;
    ...
    float lowpassWeight =1.0-0.0*mouse.y; //0.0;
